...
# === CONFIG ===
BOT_TOKEN = '7494328700:AAFVHztc1BWDkC2dWRI5PL3GmqgBi2KTWOA'
...
async def vps_info_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        try:
            url_status = subprocess.check_output("curl -s -o /dev/null -w '%{http_code}' https://console.dashwave.io/workspace/8450", shell=True).decode().strip()
        except Exception:
            url_status = "error"
    ...
    try:
        ...
        try:
            url_check = subprocess.run(
                "curl -s -o /dev/null -w '%{http_code}' https://console.dashwave.io/workspace/8450",
                shell=True,
                capture_output=True,
                text=True
            )
...
if __name__ == '__main__':
    ...
    def heartbeat():
        url = "https://console.dashwave.io/workspace/8450"
        while True:
            try:
